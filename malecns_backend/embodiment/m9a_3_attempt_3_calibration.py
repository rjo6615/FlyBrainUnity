...
ATTEMPT_2_DIR = HERE / "interface_output" / "m9a_3_matched_control_calibration_attempt_2"
ATTEMPT_2_FORENSICS = HERE / "interface_output" / "m9a_3_attempt_2_postrun_forensics"
OUTPUT_DIR = HERE / "interface_output" / "m9a_3_matched_control_calibration_attempt_3"
REPORT_PATH = OUTPUT_DIR / "m9a_3_attempt_3_report.json"
MANIFEST_PATH = OUTPUT_DIR / "m9a_3_attempt_3_manifest.json"
PREREGISTRATION_PATH = OUTPUT_DIR / "m9a_3_attempt_3_preregistration.json"
SCHEMA = "M9A-3-MATCHED-CONTROL-PHYSICS-ONLY-CALIBRATION.3"

NO_SELECTION = "NO_PREREGISTERED_CANDIDATE_QUALIFIES"
...
HISTORICAL = {
    ...
    "attempt2/m9a_3_attempt_2_preregistration.json": (4797, "ef2e184329be824cddb981f2cd6865bea2370e372d02d8ff5270cbeb472d5289"),
    "attempt2/candidate_0.256000_P_raw.npz": (3112848, "0a9d2e1bf4afff09d89024b519e98887239fa8251cdbcc91aef66e175f0594bc"),
    "attempt2/candidate_0.256000_C_raw.npz": (3098301, "65131425a23fdeaebed7983d76047a65f89a08ae25841e54045d7bcc1b371dae"),
    "attempt2/candidate_0.512000_P_raw.npz": (3116108, "44c214e9cbbac745f8edd0080943fe3d0267a9a06e1dfeddb48d430a4e793ca2"),
    "attempt2/candidate_0.512000_C_raw.npz": (3098301, "65131425a23fdeaebed7983d76047a65f89a08ae25841e54045d7bcc1b371dae"),
    "attempt2/candidate_1.024000_P_raw.npz": (3132308, "d13435568696172b5e5a0c24cb0886a3c97ba5cc92ca9773f538fd8973d60312"),
    "attempt2/candidate_1.024000_C_raw.npz": (3098301, "65131425a23fdeaebed7983d76047a65f89a08ae25841e54045d7bcc1b371dae"),
    "attempt2/candidate_2.048000_P_raw.npz": (3126755, "4bc2c10cb13ee517d37eeaea7d45d1d5c2a6618ab5afd83078477f453acce753"),
    "attempt2/candidate_2.048000_C_raw.npz": (3098301, "65131425a23fdeaebed7983d76047a65f89a08ae25841e54045d7bcc1b371dae"),
    "attempt2_forensics/m9a_3_attempt_2_postrun_forensics.json": (35653, "c7658b9ef4c2ab6ed935785b6f01090ef429207e75438080706155b237aeb2d8"),
}
...
CANONICAL_LF_TEXT_EVIDENCE = frozenset({
    ...
    "attempt2/m9a_3_attempt_2_preregistration.json",
    "attempt2_forensics/m9a_3_attempt_2_postrun_forensics.json",
})
...
EXACT_BYTE_BINARY_EVIDENCE = frozenset({
    ...
    "attempt2/candidate_0.256000_P_raw.npz", "attempt2/candidate_0.256000_C_raw.npz",
    "attempt2/candidate_0.512000_P_raw.npz", "attempt2/candidate_0.512000_C_raw.npz",
    "attempt2/candidate_1.024000_P_raw.npz", "attempt2/candidate_1.024000_C_raw.npz",
    "attempt2/candidate_2.048000_P_raw.npz", "attempt2/candidate_2.048000_C_raw.npz",
})
...
def _historical_path(key: str) -> Path:
    ...
    if prefix == "attempt2": return ATTEMPT_2_DIR / name
    if prefix == "attempt2_forensics": return ATTEMPT_2_FORENSICS / name
...
def protocol() -> dict[str, Any]:
    ...
    return {
        "schema": SCHEMA, "status": "NOT_RUN", "experiment_namespace": "M9A-3-Attempt-3",
        "attempt_provenance": {"attempt": 3, "predecessor": "M9A-3-Attempt-2",
            "predecessor_disposition": "NO_PREREGISTERED_CANDIDATE_QUALIFIES",
            "scientific_protocol_change_from_predecessor": "causal attribution of safety only"},
        ...
        "baseline_characterization": {"interval_ms":"0 <= t < 500", "per_condition":["maximum_absolute_root_linear_speed","maximum_absolute_displacement","maximum_tilt","fall","rollover","contact_state"], "exact_p_c_equivalence":True, "qualification_role":"descriptive; shared baseline speed is not a disqualifier"},
        "attempt_2_rationale": {"production_result":"NO_PREREGISTERED_CANDIDATE_QUALIFIES", "shared_speed_max":41.54495248689062, "state_index":61, "timestamp_ms":6.100000000000003, "velocity_xyz":[-4.922182135683325,-0.9162088712959617,-41.24215999999658], "retrospective_rescoring_prohibited":True},
        ...
        "selection_rule_preregistered": {
            ...
            "safety": {"finite_both": True, "no_fall_launch_or_rollover_through_ms": 750.0,
                ...
                "absolute_tilt_deg_each_condition": 60.0,
...
def choose_candidate(rows: Sequence[Mapping[str, Any]]) -> float | str:
    ...
    for r in rows:
        ...
        safe = (r["finite_both"] and not r["catastrophic_through_750ms"]
            ...
            and r["post_force_observation_ms"] >= 980)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    from . import _windows_m9a_3_attempt_3_adapter as adapter
