...
public static class M7FCanonicalReplaySceneGenerator
{
    ...
    public static void CreateCanonicalReplayScene()
    {
        ...
        replaySystem.gameObject.AddComponent<M7FScientificUI>().Configure(controller);
    ...
    {
        var root = Child(parent, name); var builder = root.gameObject.AddComponent<M7FScientificFlyBuilder>(); builder.Rebuild(); return root.GetComponent<M7FFlyRig>();
    }
